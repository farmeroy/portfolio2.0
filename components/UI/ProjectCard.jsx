 ...
 return (
    <Card sx={{  height:"100%", display: "flex", flexDirection: "column", justifyContent: "space-between" }} variant="outlined" >
      ...
      <CardActions sx={{justifySelf: 'flex-end'}} >
        {props.caseStudy &&
        <Button size="small" color="secondary" variant="outlined"><Link underline='none' href={`/case-studies/${props.caseStudy}`} size="small" color="secondary" variant="outlined">Case Study</Link></Button> }
        {props.liveUrl && 
